    ...
    loop {
        ...
        loop {
            if adm {
                ...
                println!("Escolha: 1. Listar 2. Comprar 3. Abrir jogo 4. Logout");
            }
...
fn abrir_jogo_cli(conn: &mut PooledConn, usuario_id: u32) {
    ...
    let saldo_inicial = obter_saldo(conn, usuario_id).unwrap_or(0.0);
    ...
    loop {
        ...
        println!("[{}] Ganho total: R${:.2} | Saldo atual: R${:.2}", nome_jogo, ganho_total, saldo_inicial + ganho_total);
    }
}
